...
<plugin key="SSZone" name="AC Security zone" author="Erwanweb" version="0.0.2" externallink="https://github.com/Erwanweb/BoilerCLite.git">
    ...
    <params>
        ...
        <param field="Mode5" label="Detection delay, Alarm On delay, Alarm Off delay (all in seconds)" width="100px" required="true" default="3,1,3"/>
...
class BasePlugin:
    ...
    def onStart(self):
        ...
        self.Alarmrequester = parseCSV(Parameters["Mode1"])
